...
using System;
using DelegationPokerApp.App_Start;
using DelegationPokerApp.Utilities;
using DelegationPokerApp.Configuration;
using DelegationPokerApp.Services;
using DelegationPokerApp.Authentication;
using DelegationPokerApp.Filters;
...
namespace DelegationPokerApp
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "DelegationPokerApp"))
                .EnableSwaggerUi();
