import { CanActivate, Component, ChangeDetectionStrategy } from "angular-rx-ui/src/components/core";
import * as actions from "./you-tube-video.actions";

var YT: any;

@Component({
    template: require("./you-tube-video-player.html"),
    styles: [require("./you-tube-video-player.component.scss")],
